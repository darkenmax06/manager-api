...
function validateComment (req:Request,_:Response,next:NextFunction){
  const userSchema = z.object({
    title: z.string("Debes proporcionar un titulo para poder realizar esta accion").min(2,"El titulo debe tener un minimo de 2 caracteres").max(100,"EL titulo debe tener un maximo de 100 caracteres"),
